...
namespace ToolFramework {
  ...
  public:
    ...
    bool SendROOTplot(const std::string& plot_name, const std::string& draw_options, const std::string& json_data, bool acknowledged=false, const uint64_t timestamp=0, const unsigned int lifetime=0, const unsigned int timeout=default_timeout);
    bool SendROOTplotMulticast(const std::string& plot_name, const std::string& draw_options, const std::string& json_data, const unsigned int lifetime=0, const uint64_t timestamp=0);
    bool SendROOTplotZmq(const std::string& plot_name, const std::string& draw_options, const std::string& json_data, int* version=nullptr, const uint64_t timestamp=0, const unsigned int lifetime=0, const unsigned int timeout=default_timeout);
    ...
    bool SendPlotlyPlot(const std::string& name, const std::string& json_trace, const std::string& json_layout="{}", int* version=nullptr, const uint64_t timestamp=0, const unsigned int lifetime=0, unsigned int timeout=default_timeout);
    bool SendPlotlyPlot(const std::string& name, const std::vector<std::string>& json_traces, const std::string& json_layout="{}", int* version=nullptr, const uint64_t timestamp=0, const unsigned int lifetime=0, unsigned int timeout=default_timeout);
